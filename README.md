...
也可以按需手动复制或软链单个技能目录（如 `skills/play-reviews/`）到 `~/.agents/skills/` 或项目的 `.agents/skills/` 下。
...
| [play-reviews](skills/play-reviews/) | Google Play 评论抓取 + 本地看板：多包切换、T1/T2/T3 市场层级、时间/星级/地区筛选、CSV/文本导出、离线模式 |
